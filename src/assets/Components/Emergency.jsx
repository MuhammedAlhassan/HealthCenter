        ...
        <div className="emergency-contacts">
          ...
          <div className="contacts-grid">
            <div className="contact-card">
              ...
              <a href="tel:+2348167769208" className="btn btn-destructive w-full">Call Now</a>
            </div>
            ...
            <div className="contact-card">
              ...
              <a href="tel:+2348167769208" className="btn btn-primary w-full">Call Now</a>
            </div>
            ...
            <div className="contact-card">
              ...
              <a href="tel:+2348167769208" className="btn btn-secondary w-full">Call Now</a>
            </div>
          </div>
        </div>
